...
import 'package:absensi/Widgets/custom_alert_dialog2.dart';
...
import 'package:absensi/company_data.dart';
...
class PresenceController extends GetxController {
  ...
  Future<void> processPresence(
      Position position, String name, String address, double distance) async {
    ...
    if (distance <= 200) {
      ...
      if (snapshotPreference.docs.length == 0) {
        ...
        firstPresence(presenceCollection, todayDocId, position, name, address,
            distance, in_area);
      } else {
